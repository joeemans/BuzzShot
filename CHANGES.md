...
- Started from an empty workspace with no valid Git history, so this implementation is a true greenfield monorepo bootstrap.
...
- Account settings expose email and username as read-only until verification-backed edit flows are added.
